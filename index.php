...
<head>
    <title>E-Tank System Home</title>
    <meta charset="utf-8">
...
<body ng-controller="indexController">
        ...
        <div class="logo"><h3 style="color:white;font-size:1.8em;text-align:left;">E-Tank Systems</h3></div> 
        </div>
           <br>
...
<script type="text/ng-template" id="logInModalContent.html">
        ...
        <form class="form-horizontal" name="logInForm">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Log In to E-tank</h4>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group" >
                                 ...
                                 <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                    <label class="radioBtnLabel" style="padding:3px">customer</label><input  type="radio" data-ng-model="data.logValue" value="customer">
                                    </div>
                                    <div class="col-md-3">
                                    <label class="radioBtnLabel" style="padding:3px">supplier</label><input  type="radio" data-ng-model="data.logValue" value="supplier">
                                    </div>                               
                             </div>    
                             <br>
                             </div>
