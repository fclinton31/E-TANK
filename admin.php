...
<body ng-controller="adminController">
    ...
    <div class="col-md-12 nav-pills-container">
        <ul class="nav nav-pills">           
            ...
            <li><a href="adminUserReport.php">Report</a></li>   
            <li><a href="tankView.php">View Tanks</a></li>             
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-12 search-and-results-container">
         ...
         <div class="input-group add-on">
             <input class="form-control" placeholder="Search Customer" name="srch-term" id="srch-term" type="text"  ng-model="filterUsers">
    ...
    <!-- Patient Registration Modal -->
        <form class="form-horizontal" name="registerForm">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{updateStatus}} Customer</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                    <label class="radioBtnLabel" style="padding:3px">customer</label><input  type="radio" data-ng-model="patientData.logValue" value="customer">
                                    </div>
                                    <div class="col-md-3">
                                    <label class="radioBtnLabel" style="padding:3px">supplier</label><input  type="radio" data-ng-model="patientData.logValue" value="supplier">
                                    </div>                               
                             </div> 
                </div>
            </div>
